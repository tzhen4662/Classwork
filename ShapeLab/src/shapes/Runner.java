...
public class Runner {
	...
	public static void main(String[] args) {
		...
		Shape triangle1 = new Triangle(3, 5, 4);
		Shape rhombus1 = new Rhombus(7, 6);
		...
		System.out.println("Total Area: " + ShapeUtilities.sumArea(shapeArr)); // 195.26
		System.out.println("Total Perimeter: " + ShapeUtilities.sumPerimeter(shapeArr)); // 117.28
		System.out.println("\nDid the five shapes above add up to the total printed here?\n");
